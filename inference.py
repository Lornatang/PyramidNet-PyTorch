...
def build_model(
    ...
    pyramidnet_model = model.__dict__[model_arch_name](alpha=model_alpha, num_classes=model_num_classes)
    pyramidnet_model = pyramidnet_model.to(device=device, memory_format=torch.channels_last)

    return pyramidnet_model
...
def main():
    ...
    pyramidnet_model = build_model(args.model_arch_name, args.model_alpha, args.model_num_classes, device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_arch_name", type=str, default="pyramidnet101")
    parser.add_argument("--model_alpha", type=int, default=360)
    ...
    parser.add_argument("--model_weights_path", type=str, default="./results/pretrained_models/PyrmaidNet101_a360-ImageNet_1K-f040502b.pth.tar")
