...
if mode == "train":
    ...
    lr_scheduler_milestones = [60, 90, 105]
...
if mode == "test":
    ...
    model_weights_path = "./results/pretrained_models/PyrmaidNet101_a360-ImageNet_1K-f040502b.pth.tar"
